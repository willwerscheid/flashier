...
types (e.g., GNLY for NK cells, S100A9 for CD14+ cells, CD3D for T
cells), although not always; some genes show large expression
increases more than one factor. We caution that this simple
rule-of-thumb—annotating the factors by the genes with the largest
increases in expression—may not always be helpful.
