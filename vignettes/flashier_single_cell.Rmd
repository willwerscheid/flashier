...
By default, the order of stacking is determined by the proportion of variance 
explained by each factor. The bottom factor k1 is present in all cell types, 
...
Also note that factors 7 and 8 are present in very few cells and probably
