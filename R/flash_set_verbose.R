...
#'   change in the overall variational lower bound (ELBO) and the maximum
#'   (absolute) change over all L2-normalized loadings
#'   \eqn{\ell_1, \ldots, \ell_K} and factors \eqn{f_1, \ldots, f_K}. Update
#'   information is customizable via parameters \code{fns}, \code{colnames},
#'   and \code{colwidths}.
#'
...
#'   being updated during sequential backfits (that is, in calls to
