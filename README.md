...
Finally, I recommend taking a look at the vignettes before diving in. Be forewarned, however, that they take a few minutes to build (it took me a little less 5 minutes on a 2015 MacBook Pro). If you choose to build them, make sure you've installed the above packages first. Then run:
