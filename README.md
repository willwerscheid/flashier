...
Functions were re-named in Version 0.2.44. Please note the following changes:
...
Parameter names were changed as well; please see the documentation for details.
